    ...
    return (
        <div className="main">
            <span>
                {showInfo? 
                <div className='box2'>
                    <h1 onClick={handleShow}>{robot.gundamName}</h1>
                    <img src={robot.imageLink} className='image' onClick={handleShow}></img>
                ...
                <div className='container'>
                    <div className='box'>
                        <img src={props.robot.imageLink} className='image' onClick={handleShow}></img>
                        <h1 onClick={handleShow}>{props.robot.gundamName}</h1>
                        <div className='price'>

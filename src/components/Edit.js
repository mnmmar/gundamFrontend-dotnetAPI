    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className='edit'>
                <label>Name: </label>
                <br></br>
                <input type='text' name='name' value={robot.gundamName} onChange={handleChange}></input>
                <br></br>
                ...
                <br></br>
                <input type='text' name='image' value={robot.imageLink} onChange={handleChange}></input>
                <br></br>

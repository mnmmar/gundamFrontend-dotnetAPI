...
const Add = (props) => {
    let emptyGundam = {gundamName: '', price: '', shippingCost: '', shippingDate: '', imageLink: ''}
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className='edit'>
                <label>Name: </label>
                <br></br>
                <input type='text' name='gundamName' value={robot.gundamName} onChange={handleChange}></input>
                <br></br>
                ...
                <br></br>
                <input type='text' name='imageLink' value={robot.imageLink} onChange={handleChange}></input>
                <br></br>
